...
import MessageItemView from "./message-chat-item.view";
...
export default (props: Props): React.ReactElement => {
  ...
  const { channelId, localCodeId, isNewMessenger, lastConversationSeen } =
  ...
  const submitConversation = async () => {
    ...
    if (!channelId || !localCodeId) return;
