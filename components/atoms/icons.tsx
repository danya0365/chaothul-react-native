...
import ScanQrCodeSvg from "./svg/scan-qr-code-svg";
...
export const TabBarHeartOutlineIcon = (style: IconProps): IconElement => (
...
export const TabBarCameraOutlineIcon = (props: IconProps): IconElement => {
  const fillColor = props.style.tintColor;
  return <ScanQrCodeSvg {...props} fill={fillColor} />;
};

export const CustomerOutlineIcon = (style: IconProps): IconElement => (
  <Icon {...style} name="person-outline" />
);

export const MerchantOutlineIcon = (style: IconProps): IconElement => (
  <Icon {...style} name="briefcase-outline" />
);

export const CameraOutlineIcon = (props: IconProps): IconElement => (
  <ScanQrCodeSvg {...props} />
);

export const GiftOutlineIcon = (style: IconProps): IconElement => (
  <Icon {...style} name="gift-outline" />
);

export const AwardOutlineIcon = (style: IconProps): IconElement => (
  <Icon {...style} name="award-outline" />
);

export const PantoneOutlineIcon = (style: IconProps): IconElement => (
  <Icon {...style} name="pantone-outline" />
);
...
export const TabBarMessageSquareOutlineIcon = (
  style: IconProps
): IconElement => <Icon {...style} name="message-square-outline" />;
...
export const ColorPaletteOutlineIcon = (style: IconProps): IconElement => {
  return <IconWithTheme name="color-palette-outline" {...style} />;
};
